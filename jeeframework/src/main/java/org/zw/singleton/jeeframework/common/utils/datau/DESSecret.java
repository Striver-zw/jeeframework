...
//package zw.singleton.jeeframework.common.utils.datau;
...
//		String temp = Base64.encodeToString(encryptedData, 0);
...
//		cipher.init(Cipher.ENCRYPT_MODE, key, zeroIv);
//		byte[] encryptedData = cipher.doFinal(encryptString.getBytes("UTF-8"));
//		String temp = Base64.encodeToString(encryptedData, Base64.NO_WRAP);
//		String secret = URLEncoder.encode(temp,"UTF-8");
//		return secret;
//	}
//	
...
//		byte str2[] = Base64.decode(str1.getBytes(),Base64.DEFAULT);
//		IvParameterSpec zeroIv = new IvParameterSpec(iv);
