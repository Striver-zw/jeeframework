...
<head>
		<meta charset="utf-8" />
		<title>Jeeframework后台管理系统模版</title>
	...
	<jsp:include page="/WEB-INF/views/commom/header.jsp"></jsp:include>
									...
									<div class="col-xs-12">
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<c:forEach items="${sqlInfo.listInfo }" var="s">
													<tr>
														<td class="center">
															<label>
																<input type="checkbox" class="ace" />
														...
														<td class="center">${sqlInfo.tableName }</td>
														<td class="center">${s.coulumnName }</td>
														<td class="center">${s.columnType }</td>
