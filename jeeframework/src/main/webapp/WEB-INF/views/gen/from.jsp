...
<%@ include file="/WEB-INF/views/commom/menu.jsp" %>  
 ...
 -->
								<div class="widget-box">
									...
									<!-- <i class="ace-icon fa fa-arrow-left" onclick="window.history.go(-1);"></i> -->
										<h5><i class="widget-title lighter ace-icon fa fa-arrow-left" onclick="window.history.go(-1);"></i></h5>
<!--
